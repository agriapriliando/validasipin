...
<head>
    ...
    <meta name="copyright" content="Agri Apriliando">
    <title>FormPIN</title>
    <meta name="title" content="Formulir PIN IAKNPKY" />
    <meta name="description" content="Layanan PIN IAKN Palangka Raya. Dikelola Oleh UPT TIPD IAKN Palangka Raya" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Formulir PIN IAKNPKY" />
    <meta property="og:description" content="Layanan PIN IAKN Palangka Raya. Dikelola Oleh UPT TIPD IAKN Palangka Raya" />
    <meta property="og:image" content="{{ asset('assets/iaknpky_pin_seo.jpg') }}" />
    ...
    <meta property="twitter:title" content="Formulir PIN IAKNPKY" />
    <meta property="twitter:description" content="Layanan PIN IAKN Palangka Raya. Dikelola Oleh UPT TIPD IAKN Palangka Raya" />
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light sticky-top bg-white shadow-sm">
            <div class="container">
                <a href="{{ url('') }}" class="navbar-brand">Form<span class="text-primary">PIN</span></a>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-5 py-1">
                    <h3>Form<span class="text-primary">PIN</span></h3>
                ...
                <div class="col-lg-2 py-1">
                    ...
                    <div class="sosmed-button mt-4">
                        <a href="https://www.facebook.com/iaknpky" target="_blank"><span class="mai-logo-facebook-f"></span></a>
                        <a href="https://www.instagram.com/iakn_palangkaraya/" target="_blank"><span class="mai-logo-instagram"></span></a>
                    </div>
                </div>
            </div>
